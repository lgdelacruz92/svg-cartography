...
parser.add_argument('-y', '--year', help='Year of the census.')
parser.add_argument('-p', '--projection', help='d3 projection to use.')
parser.add_argument('-f', '--fips', help='State fips.')
